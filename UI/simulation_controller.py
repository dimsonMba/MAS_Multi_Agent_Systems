...
class SimulationController:
    ...
    def _snapshot(self) -> dict:
        ...
        temps = [a.temperature for a in self.model.thermal_agents]
        fan_speeds = [a.fan_speed for a in self.model.thermal_agents]
        return {
    ...
    def set_fan_speed(self, zone_id: int, speed: int) -> None:
        ...
        if 0 <= zone_id < len(self.model.thermal_agents):
            self.model.thermal_agents[zone_id].fan_speed = max(0, min(255, speed))
